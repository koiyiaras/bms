    ...
    <div class="bms-container dashboard">
        ...
        <div id="dash-nav">
            ...
            <div class="row text-center mt-4">
                ...
                <div class="col-md-6">
                    <a href="/quotes/" class="btn btn-success btn-lg btn-block mb-4">
            ...
            <div class="row text-center mt-4">
                <div class="col-md-6">
                    <a href="/invoices/" class="btn btn-warning btn-lg btn-block mb-4">
                ...
                <div class="col-md-6">
                    <a href="/balances/" class="btn btn-danger btn-lg btn-block mb-4">
            ...
            <div class="row text-center mt-4">
                <div class="col-md-6">
                    <a href="/projects/" class="btn btn-dark btn-lg btn-block mb-4">
                ...
                <div class="col-md-6">
                    <a href="/stock/" class="btn btn-secondary btn-lg btn-block mb-4">
